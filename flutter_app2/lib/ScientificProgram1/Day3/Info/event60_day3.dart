...
class event60_day3 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' ENV-002  	',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
            ...
            Text(" ENV-002 ผลิตภัณฑ์คอนกรีตบล็อกประสานปูพื้นผสมเศษขวดพลาสติกสีเหลือทิ้ง "),
            Text(""),
