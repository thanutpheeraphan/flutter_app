...
class event50_day3 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' การก่อสร้างฐานรากด้วยเสาเข็มสปัน (Spun pile) และระบบติดตั้งเสาเข็มเจาะสำเร็จรูป (Double rod auger) โครงการ The Uppergrounds  	',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
            Text('27.03.20    10:00 - 10:30',  style: TextStyle(fontStyle: FontStyle.italic,fontSize: 15) , ) ,
