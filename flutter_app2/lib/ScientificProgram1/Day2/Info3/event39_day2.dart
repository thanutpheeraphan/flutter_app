    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' MAT-018  EFFECTS OF FLY ASH AND EXPANSIVE ADDITIVE ON SHRINKAGE CRACKING AND CHLORIDE PENETRATION RESISTANCES OF CONCRETE',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
