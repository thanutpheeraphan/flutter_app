...
class event35_day2 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' ICM-009  Non-shrink grout',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
                    ...
                    children: <Widget>[Text('       '),Image.asset('assets/images/info3.png'),
                      Container(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text('     Phattarakamon Chaiyapoom',  overflow: TextOverflow.ellipsis , maxLines: 1, style: GoogleFonts.notoSans(fontSize: 16))],
                        ),
                      ),
                    ],
                  ),
