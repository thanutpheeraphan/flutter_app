...
class event38_day2 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' GTE-002  COMPRESSIVE STRENGTH OF RECYCLED BASED MATERIALS IMPROVED BY POLYVINYLALCOHOL AND CEMENT',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
            ...
            Text("GTE-002  COMPRESSIVE STRENGTH OF RECYCLED BASED MATERIALS IMPROVED BY POLYVINYLALCOHOL AND CEMENT"),
            Text(""),
                    ...
                    children: <Widget>[Text('       '),Image.asset('assets/images/info3.png'),
                      Container(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text('     Chaiwat Waree',  overflow: TextOverflow.ellipsis , maxLines: 1, style: GoogleFonts.notoSans(fontSize: 16))],
                        ),
                      ),
                    ],
                  ),
