...
class event44_day2 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' MAT-023  Load Carrying Capacity Modelling of RC Girders Reinforced by Prestressed Rubber Pads',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
            ...
            Text("MAT-023  Load Carrying Capacity Modelling of RC Girders Reinforced by Prestressed Rubber Pads"),
            Text(""),
                    ...
                    children: <Widget>[Text('       '),Image.asset('assets/images/info3.png'),
                      Container(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text('     Sutta Somboonbab',  overflow: TextOverflow.ellipsis , maxLines: 1, style: GoogleFonts.notoSans(fontSize: 16))],
                        ),
                      ),
                    ],
                  ),
