...
class event43_day2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String _launchURL = "https://drive.google.com/file/d/19ZVifJ1CqmCUgbwABY3FhgBJ89vSRdb0/view?usp=sharing" ;
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('26.03.20    11:10 - 11:30',  style: TextStyle(fontStyle: FontStyle.italic,fontSize: 15) , ) ,
