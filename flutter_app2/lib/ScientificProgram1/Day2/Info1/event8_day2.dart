    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' MAT-010 การศึกษาเบื้องต้นการประยุกต์ใช้แผ่น viscoelastic polymer ในการปรับปรุงคุณสมบัติการสั่นสะเทือนและเสียงในแผ่นคอนกรีตหล่อสำเร็จ',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
