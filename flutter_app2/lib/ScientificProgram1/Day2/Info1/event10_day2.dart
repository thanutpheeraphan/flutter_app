...
class event10_day2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    String _launchURL = "https://drive.google.com/file/d/1EdijOmbrxxZfLhwk7IZHywZybtYMDi6T/view?usp=sharing";
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' MAT-012 THE EFFECT OF GRAPHENE OXIDE IN BOND STRENGTH OF SYNTHETIC FIBERS',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
            ...
            Text("MAT-012 THE EFFECT OF GRAPHENE OXIDE IN BOND STRENGTH OF SYNTHETIC FIBERS"),
            Text(""),
                    ...
                    children: <Widget>[Text('       '),Image.asset('assets/images/info3.png'),
                      Container(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text('     Apisit Techaphatthanakon ',  overflow: TextOverflow.ellipsis , maxLines: 1, style: GoogleFonts.notoSans(fontSize: 16))],
                        ),
                      ),
                    ],
                  ),
