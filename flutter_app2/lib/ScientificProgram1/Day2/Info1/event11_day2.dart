...
class event11_day2 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' MAT-013 การสังเคราะห์วัสดุทนไฟที่สามารถทนทานต่ออุณหภูมิสูงกว่า 1,600°C',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
            ...
            Text("MAT-013 การสังเคราะห์วัสดุทนไฟที่สามารถทนทานต่ออุณหภูมิสูงกว่า 1,600°C"),
            Text(""),
                    ...
                    children: <Widget>[Text('       '),Image.asset('assets/images/info3.png'),
                      Container(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text('     Jiraporn Jaikajat ',  overflow: TextOverflow.ellipsis , maxLines: 1, style: GoogleFonts.notoSans(fontSize: 16))],
                        ),
                      ),
                    ],
                  ),
