    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' STR-002 พฤติกรรมและการเสริมกำลังโครงสร้างเจดีย์ในจังหวัดพะเยา',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
