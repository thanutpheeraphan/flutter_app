...
class event19_day2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    String _launchURL ="https://drive.google.com/file/d/1VQBBISoAkgJEuaLuknj7IpC8Ejx3A66w/view?usp=sharing";
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' MAT-006 ความคงทนของคอนกรีตผสมเถ้าลอยเปียก',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
            ...
            Text("MAT-006 ความคงทนของคอนกรีตผสมเถ้าลอยเปียก"),
            Text(""),
                    ...
                    children: <Widget>[Text('       '),Image.asset('assets/images/info3.png'),
                      Container(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text('     Ditthawat Dangchum ',  overflow: TextOverflow.ellipsis , maxLines: 1, style: GoogleFonts.notoSans(fontSize: 16))],
                        ),
                      ),
                    ],
                  ),
