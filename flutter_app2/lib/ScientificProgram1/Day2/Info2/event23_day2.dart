...
class event23_day2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String _launchURL = "https://drive.google.com/file/d/1AHuB9bV8FBKJrXkNG1yU4ppAMR4YRelz/view?usp=sharing";
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' STR-003 ',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
