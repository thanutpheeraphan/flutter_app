...
class event25_day2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String _launchURL = "https://drive.google.com/file/d/1a47f7_SLPWxRlNkqcNtx8Jf_dqo20Es2/view?usp=sharing";
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' STR-005 ',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
