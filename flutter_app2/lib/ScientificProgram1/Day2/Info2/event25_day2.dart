...
class event25_day2 extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: new Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(' STR-005 EVALUATION OF LOADING CAPACITY OF HIGH-STRENGTH CONCRETE-FILLED SQUARE STEEL TUBE COLUMNS UNDER VARIOUS LOAD APPLICATION',  style: GoogleFonts.notoSans(fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.start,) ,
            ...
            Text("STR-005  EVALUATION OF LOADING CAPACITY OF HIGH-STRENGTH CONCRETE-FILLED SQUARE STEEL TUBE COLUMNS UNDER VARIOUS LOAD APPLICATION"),
            Text(""),
                    ...
                    children: <Widget>[Text('       '),Image.asset('assets/images/info3.png'),
                      Container(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text('     Jaksada Thumrongvut',  overflow: TextOverflow.ellipsis , maxLines: 1, style: GoogleFonts.notoSans(fontSize: 16))],
                        ),
                      ),
                    ],
                  ),
