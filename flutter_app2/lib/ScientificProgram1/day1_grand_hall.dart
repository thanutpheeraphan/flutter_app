      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          ...
          return AlertDialog(
            ...
            content: new Text("ลงทะเบียน (Registration)"),
            actions: <Widget>[
    ...
    void _showDialog2() {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          // return object of type Dialog
          return AlertDialog(
            title: new Text("Welcome Speech"),
            content: new Text("กล่าวต้อนรับผู้เข้าร่วมการประชุมและกล่าวขอบคุณผู้สนับสนุนการจัดการประชุมมอบรางวัล TCA Concrete Practice Awards (Opening ACC15)โดย นายกสมาคมคอนกรีตแห่งประเทศไทย (President of TCA)พิธีเปิดการประชุมและกล่าวขอบคุณผู้สนับสนุนโดย คณบดีคณะวิศวกรรมศาสตร์ มหาวิทยาลัยพะเยา"),
            actions: <Widget>[
              // usually buttons at the bottom of the dialog
              new FlatButton(
                child: new Text("Close"),
